...
* **`encapsulated-method-object`**: Refactors scope-heavy functions, bloated closures, and shared local state into encapsulated helper objects. (Strictly mandates private generative constructors + factory unpacking to prevent `late final` hazards).
