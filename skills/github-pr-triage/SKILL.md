...
6. **Wait for Approval**:
   - DO NOT edit files or make changes until the user explicitly approves the proposed plan via the interactive 'Proceed' button (or verbal confirmation).
...
8. **Verify Git State and Offer Resolution**:
   ...
   - If approved via the tool response, execute the replies and resolutions using the patterns listed below.
